@echo off
rem ============================================================================
rem DataHarness launcher for stop.ps1.
rem
rem This file only locates PowerShell 7 and forwards arguments plus exit code to
rem the .ps1 engine script; all drain/shutdown logic and ownership checks live in
rem stop.ps1. Keep this file ASCII-only (see setup.bat header).
rem ============================================================================
setlocal
set "ENGINE=%~dp0stop.ps1"
set "PWSH="
