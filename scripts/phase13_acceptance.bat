@echo off
rem ============================================================================
rem DataHarness launcher for phase13_acceptance.ps1.
rem
rem This file only locates PowerShell 7 and forwards arguments plus exit code to
rem the .ps1 engine script; all static/mock acceptance logic lives in
rem phase13_acceptance.ps1. Keep this file ASCII-only (see setup.bat header).
rem ============================================================================
setlocal
set "ENGINE=%~dp0phase13_acceptance.ps1"
set "PWSH="
