@echo off
rem ============================================================================
rem DataHarness launcher for phase13_lifecycle_acceptance.ps1.
rem
rem This file only locates PowerShell 7 and forwards arguments plus exit code to
rem the .ps1 engine script; all real-machine lifecycle logic lives in
rem phase13_lifecycle_acceptance.ps1. Keep this file ASCII-only (see setup.bat
rem header).
rem ============================================================================
setlocal
set "ENGINE=%~dp0phase13_lifecycle_acceptance.ps1"
set "PWSH="
